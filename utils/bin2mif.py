...
def main():
    parser = argparse.ArgumentParser(description="Convert a binary file to Intel/Altera .mif format")
    ...
    parser.add_argument("--depth", type=int, default=None, help="Memory depth in words (default: auto)")
    parser.add_argument("--byte-swap", action="store_true",
    ...
    print(f"\tConverted {args.input} -> {args.output} (WIDTH={args.width}, DEPTH={args.depth})")
    return
