...
MEM_SRC    	+= $(SRC_DIR)memory/rom/rom.v \
			   $(SRC_DIR)memory/ram/ram.v \
			   $(SRC_DIR)memory/behavioral/altera_mf.v

PLL_SRC    	+= $(SRC_DIR)clocks/pll_200/pll_200.v \
			   $(SRC_DIR)clocks/pll_180/pll_180.v
...
test_case: $(FILE_LIST) $(TEST_BUILD) $(INIT_RAM) $(INIT_ROM) $(BUILD_DIR)generated.h $(BUILD_DIR)generated.sv
